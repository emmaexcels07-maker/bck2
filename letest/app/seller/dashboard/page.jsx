  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="max-w-6xl mx-auto mb-8 flex justify-between items-end">
        ...
        <button className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-lg font-medium transition-all shadow-sm hover:shadow-md">
